...
### **Некоторые команды администратора**
...
| `/close message` | Закрыть бота | `/close ушел спать` |
| `/open` | Открыть бота | `/open` |
| `/unset_tos user_id` | Снять соглашение с ToS | `/unset_tos 9124924` |
